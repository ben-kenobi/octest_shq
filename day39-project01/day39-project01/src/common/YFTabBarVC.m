...
-(void )initBottom{
    if(!_bottom){
        ...
        for(int i=0;i<5;i++){
            ...
            b.tag=(i==4?-1:i);
            [b setBackgroundImage:img(iFormatStr(@"home_%d",i)) forState:UIControlStateNormal];
            [b setBackgroundImage:img(iFormatStr(@"home_%d_pressed",i)) forState:UIControlStateSelected];
